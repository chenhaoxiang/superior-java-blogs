...
public class CookieUtils {
     ...
     * @return 值
     */
    public static String getAndRemoveCookie(HttpServletRequest request, HttpServletResponse response, String name) {
