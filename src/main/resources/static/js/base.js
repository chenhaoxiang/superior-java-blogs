 ...
 */
function ajaxPost(url, parameter, successfun, async, param) {
...
function confirm(fun, params, title, content) {
    ...
    var html = "<div id='myConfirm' class='modal fade' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'><button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button><h4 class='modal-title' id='myModalLabel'>" +
        title +
        "</h4></div><div class='modal-body'>" +
        content +
        "</div><div class='modal-footer'><button type='button' class='btn btn-default' data-dismiss='modal'>" +
        "取消" +
        "</button><button type='button' id='confirmOk' class='btn btn-primary'> " +
        "确认" +
