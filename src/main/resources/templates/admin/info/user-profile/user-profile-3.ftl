                        ...
                        <div id="edit-password" class="tab-pane">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" id="form-field-pass" name="oldPassword"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" id="form-field-pass1" name="newPassword"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" id="form-field-pass2" name="newPassword1"/>
                                    </div>
                                </div>
