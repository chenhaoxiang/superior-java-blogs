                ...
                <ul class="nav nav-list">
                    ...
                    <li class="" id="pageBolg">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="" id="pageBolgListAll">
                                <a href="/admin/blogs/listAll">
                                    <i class="menu-icon fa fa-caret-right"></i> 博客列表
                                </a>

                                <b class="arrow"></b>
                            </li>

                            <li class="" id="pageBolgInsertView">
                                <a href="/admin/blogs/insertView">
                                    <i class="menu-icon fa fa-caret-right"></i> 发表博客
                                </a>
